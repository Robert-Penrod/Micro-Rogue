...
public class ActorLootDropper : MonoBehaviour
{
    ...
    void DoSpawn()
    {
        var selectedItem = ((DungeonManager.I.Data.IsBoss && Random.value < 0.5f) || (Random.value < 0.1f * DungeonManager.I.Data.EliteTier) || (Random.value < 0.1f * (DungeonManager.I.Data.RunTier - 1f)))? GemPrefab : LootPrefabTable.SelectItem();
